...
<link rel="stylesheet" href="{{asset('p_hom/styl.css')}}">
        ...
        {{-- bg-white ml-3 mr-3 mb-4 mt-4 pl-3 pt-50 pb-50 
            @if (Route::currentRouteName() == 'par_cat')--}}
        @if(isset($catgorit))
            <div class=" col-md-12 col-lg-12">
                <div class="container-fluid">
                    <div class="prod bg-white">
                        @foreach ($catgorit->sous_categ as $sous_categ)
                        
                        <a class="" href="{{URL::to('/select_par_sous_cat/'.$sous_categ->id)}}">
                            {{$sous_categ->nom_sous_categorie}}({{$sous_categ->annonces->count()}}) &nbsp; &nbsp; &nbsp;
                        </a>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="header product-view mb-0">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-12 select_cate">
                                    ...
                                    <div class="product-view-top">
                                        <form method="POST" action="{{route('an_search')}}">
                                            ...
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-6 col-lg-6 d-flex justify-content-start bd-highlight mb-0">
