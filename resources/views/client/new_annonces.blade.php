                ...
                <div class="row">
                    ...
                    <!-- leur fermerture est en bas de la page -->
                            ...
                            {{--<form method="post" action="" enctype="multipart/form-data" class="form" data-parsley-validate>
                                ...
                                <form  method="post" action="{{URL::to('creer_annonce')}}" enctype="multipart/form-data">
                                        {{csrf_field()}}
                               <div class="billing-address">
                                    <h3>Catégorie et région</h3>
                                     ...
                                     {{--<div class="form-group row">
                                            ...
                                            <div class=" col-md-6 col-sm-8">
                                                <input type="text" name="" spellcheck="false" readonl="" value=""  class="form-control">
                                            </div>
                                    </div>--}}
                                    ...
                                    <div class="form-group row dtailvhicule" id="qartier" >
                                        <label class="col-md-2 col-sm-4 col-form-label"> Quartier </label>
                                        <div class=" col-md-6 col-sm-8">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-md-6 col-sm-8">
                                            <select class="form-control productcategory" name="categorie">
                                                ...
                                                @foreach ($cate as $cat)
                                                <option value="{{$cat->id}}" {{(old('categorie')==$cat->id)? 'selected':''}}> {{$cat->nom_categorie}} </option>
                                                @endforeach
                                            </select>
                                        </div> 
                                    </div>
                            ...
                            <div class="billing-address">
                                ...
                                <div class="form-group row dtailvhicule">
                                    ...
                                    <div class=" col-md-6 col-sm-8">
                                        <input class="form-control" type="text" name="Annee" placeholder="Année" value="{{ old('Annee') }}">
                                    </div>
                                </div>
                                <div class="form-group row dtailvhicule">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 col-sm-4 col-form-label">Prix <strong>*</strong></label>
                                    <div class=" col-md-6 col-sm-8">
                                        <input class="form-control" type="number" name="Prix" value="{{ old('Prix') }}" placeholder="prix">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class=" col-md-8">
                                        ...
                                        <!-- <div class="column wide">-->
                                            <textarea class="form-control" type="text"   name="Description" placeholder="Donnez le plus de détails possible sur votre article" rows="9">{{old('Description')}}</textarea>
                            ...
                            <div class="billing-address">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class=" col-md-6 col-sm-8">
                                        <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="Entrer votre Nom">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 col-sm-4 col-form-label">Email <strong>*</strong></label>
                                    <div class=" col-md-6 col-sm-8">
                                        <input class="form-control" type="text" name="email" value="{{ old('email') }}" placeholder="Entrer votre email">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 col-sm-4 col-form-label">Mot de passe <strong>*</strong></label>
                                    <div class=" col-md-6 col-sm-8">
                                        <input class="form-control" type="password" name="password" value="{{ old('password') }}" placeholder=" Entrer un mot de passe">
                                    </div>
                                </div>
                                {{--<div class="form-group row">
                                    <label class="col-md-2 col-sm-4 col-form-label">Mot de passe</label>
                                    <div class=" col-md-4 col-sm-8">
                                        <input class="form-control" type="password" name="password" placeholder=" Entrer un mot de passe">
                                    </div>
                                </div>--}}
                                <div class="form-group row">
                                    <label class="col-md-2 col-sm-4 col-form-label">Téléphone <strong>*</strong></label>
                                    <div class=" col-md-6 col-sm-8">
                                        <input class="form-control" type="text" name="phone" value="{{ old('phone') }}" placeholder="Entrer votre contact">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-2 col-sm-4 col-form-label">Téléphone</label>
                                    <div class=" col-md-6 col-sm-8">
                                       <input class="form-control" type="text" name="phone2" value="{{ old('phone2') }}" placeholder="Entrer un 2eme contact">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-3">
